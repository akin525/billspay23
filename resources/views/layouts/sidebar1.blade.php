<head>
    ...
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href="https://paydow.ashmarkets.com/log.jpeg">
                ...
                <div class="sidebar_blog_1">
                    <div class="sidebar-header">
                        <div class="logo_section">
                            <a href="{{route('account')}}"><img class="logo_icon img-responsive" src="{{asset("log.jpeg")}}" alt="#"></a>
                        </div>
                    </div>
                    ...
                    <ul class="list-unstyled components">
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="app4">
                                    <li>
                                        <a href="{{url('pick')}}"><i class="fa fa-laptop "></i> <span>Buy Data</span></a>
                                    </li>
                                ...
                                <li>
                                    <a href="{{route('electricity')}}"><i class="fa fa-power-off"></i> <span>Pay Electricity</span></a>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{route('profile.show')}}"><i class="fa fa-user "></i> <span>My Account</span></a>
                        </li>
                        <li>
                            <a href="{{route('notification')}}"><i class="fa fa-bell"></i> <span>Notification</span></a>
                        </li>
                        <li>
                            <a href="{{route('deposit')}}"><i class="fa fa-money"></i> <span>All Deposit</span></a>
                        </li>
{{--                        <li>--}}
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="full">
                            ...
                            <div class="logo_section m-1">
                                <a href="{{ route('account') }}"><img class="img-responsive" src="{{asset("log.jpeg")}}" alt="#" /></a>
                            </div>
                            <br>
                            {{--                        @if(Auth::user()->pin =="0")--}}
