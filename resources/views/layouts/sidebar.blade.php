                        ...
                        <div class="input-group search-area">
                            ...
                            <span class="input-group-text"><a href="javascript:void(0)">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<path opacity="0.3" d="M14.2929 16.7071C13.9024 16.3166 13.9024 15.6834 14.2929 15.2929C14.6834 14.9024 15.3166 14.9024 15.7071 15.2929L19.7071 19.2929C20.0976 19.6834 20.0976 20.3166 19.7071 20.7071C19.3166 21.0976 18.6834 21.0976 18.2929 20.7071L14.2929 16.7071Z" fill="#046CB5"/>
										<path d="M11 16C13.7614 16 16 13.7614 16 11C16 8.23859 13.7614 6.00002 11 6.00002C8.23858 6.00002 6 8.23859 6 11C6 13.7614 8.23858 16 11 16ZM11 18C7.13401 18 4 14.866 4 11C4 7.13402 7.13401 4.00002 11 4.00002C14.866 4.00002 18 7.13402 18 11C18 14.866 14.866 18 11 18Z" fill="#046CB5"/>
										</g>
										<defs>
...
{{--                <li><a class="" href="{{url('vtu')}}" aria-expanded="false">--}}
{{--                        <div class="menu-icon">--}}
{{--                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
{{--                                <g opacity="0.5">--}}
...
{{--                            </svg>--}}
{{--                        </div>--}}
{{--                        <span class="nav-text">Own A Website</span>--}}
{{--                    </a>--}}
...
{{--                        <li><a href="{{route('datapin')}}">Buy Data-pin</a></li>--}}
                ...
                <li><a href="{{route('invoice')}}" class="" aria-expanded="false">
                        <div class="menu-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.5">
...
{{--                </li>--}}
                ...
                <li><a href="{{route('upgrade')}}" class="" aria-expanded="false">
                        <div class="menu-icon">
{{--                            <i class="fa fa-user-alt" style="font-size: x-large"></i>--}}
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.5">
                        ...
                        <span class="nav-text">My Apikey</span>
                    </a>
                </li>
                @endif
                ...
                <li><a href="{{route('deposit')}}" class="" aria-expanded="false">
                        <div class="menu-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.5">
