    ...
    <div class="row">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="#" class="btn btn-primary btn-sm ms-2">+ Add User</a>
            </div>
        </div>
                                ...
                                <div class="card-body">
                                    <div class="card-use-box">
                                        <div class="crd-bx-img">
                                            <img width="200" src="{{asset('logo.jpeg')}}" class="rounded-circle" alt="">
                                        ...
                                        <div>
                                            <a href="{{route('admin/profile',$user['username'])}}" class="btn btn-primary btn-sm me-2">Edit</a>
                                            <a href="javascript:void(0)" class="btn btn-secondary btn-sm ms-2" >Message</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
