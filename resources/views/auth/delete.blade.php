                ...
                <div class="row justify-content-center pt-5">
                    <div class="col-md-9">
                        <div class="card  d-flex justify-content-center mb-0 auth-card iq-auth-form">
                            <div class="card-body">
                                <h2 class="mb-2 text-center">Delete Account</h2>
                                <p class="text-center">Enter your detail</p>
                                    ...
                                    <div class="row subscribe">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="username" class="form-control" id="username" aria-describedby="email" >
                                            </div>
                                        </div>
                                        <button type="submit" class="submit-btn btn-primary">Delete Now<span class="load loading"></span></button>
                                    </div>
                                    <br/>
                                    <script>
